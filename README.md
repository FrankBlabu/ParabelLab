...
(Step 06), Module 2: Normal Form to Vertex Form (Step 07), Module 3: Basic
Term Transformations (Step 08), the App Shell & Navigation (Step 09), and
Progress Tracking & Persistence (Step 10) are implemented. 
See [doc/planning/00-overview.md](doc/planning/00-overview.md)
